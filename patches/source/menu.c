...
__attribute_reloc__ void (*draw_box)(u32 type, void* blob, GXColor* color);
...
__attribute_used__ void custom_gameselect_menu(u8 alpha_0, u8 alpha_1, u8 alpha_2) {
    ...
    draw_box(make_type('m','e','s','6'), *(void**)0x814815e4, &white); // TODO: move this to reloc (also color change)
